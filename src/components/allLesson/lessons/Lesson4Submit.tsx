  ...
  return (
    <>
      ...
      <form className="p-8 max-w-full " onSubmit={handleSubmit(onSubmit)}>
        ...
        <button
          className={` bg-blue-100 hover:opacity-90 text-white mt-10 font-medium rounded-lg text-sm px-5 py-2.5 text-center  bg-blue-500`}
          type="submit"
        >
          Submit
        </button>
